...
\textbf{Type} && \textbf{From} & \textbf{To} \\
\hline
Account index & \verb|index| in... & 1 & 1000 \\
Sender balance & \verb|balance| in... & 2 & 1000 \\
Transfer amount & \verb|transfer| in... & 2 & 1000 \\
\end{tabular}
\end{center}
...
\begin{itemize}
\item \verb|index|: 1, \verb|balance|: 2, \verb|transfer|: 2
\item \verb|index|: 2, \verb|balance|: 3, \verb|transfer|: 3
\item \verb|index|: 3, \verb|balance|: 4, \verb|transfer|: 4
\item ...
\end{itemize}
