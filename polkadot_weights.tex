...
The Runtime reuses components, so called "primitives", to interact with the state. The behavior and
the execution cost of those primitives can be studied and a Weight can be applied for each use
withing the Runtime code.
\newline

Common primitives are the following:
