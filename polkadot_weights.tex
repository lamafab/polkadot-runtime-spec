...
without exceeding any limitations (section \ref{sec:limitations}).
\newline

Polkadot also introduces a specified block ratio (section \ref{sec:limitations}), ensuring that only a certain
