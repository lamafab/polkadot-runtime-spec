...
without exceeding any limitations~\ref{sec:limitations}.
\newline

Polkadot also introduces a specified block ratio (references to where it is specified), ensuring that only a certain
