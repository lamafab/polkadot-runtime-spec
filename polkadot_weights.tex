...
accounts, one could select a range of very small balances being sent from one to thousands of
accounts, to very large balances being sent from one to thousands of accounts.
\newline
...
or too extreme ranges might give an inaccurate execution cost of the function as being used in production.
Therefore, when a range of input parameters gets benchmarked, the result of each individual parameter
should be recorded and ideally visualized. The author should then select the most probable average
