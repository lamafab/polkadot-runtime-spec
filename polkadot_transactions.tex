...
individual values and use the worst time that comes out.
\newline

It should be strictly ensured that subsequent calls do not benefit from earlier
caching. This might be possible by just randomizing everything, but it is probably
better to clear all caches between calls.
