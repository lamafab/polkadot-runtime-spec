...
a function, apply \verb|target_block_fullness| to this time, yielding
\verb|250_000_000ns| (nano seconds) as the available block execution time.
...
how much slower web-assembly can be, which current is \verb|5|.
...
Note that the weights are factored by \verb|1'000| for simplicity and to correct
the fee values.
...
\begin{center}
  \begin{tabulary}{1.0\textwidth}{LLL}
    ...
    \texttt{available\_block\_execution\_time} & 250\_000\_000ns & \\
    \texttt{total\_block\_weight} & 1\_000\_000\_000 & \\
    \texttt{available\_block\_weight} & 250\_000\_000 & \\
    \hline
  \end{tabulary}
\end{center}
