...
Polkadot also introduces an available block ratio, ensuring that only a certain
portionl of the total block sizes gets used for regular extrinsics. The remaining
space is reserved for critical, operational extrinsics required by Polkadot itself.
