...
\texttt{250\_000\_000} (nano seconds) as the available block execution time.
...
\texttt{available\_block\_execution\_time} to obtain what ration of the block time it
consumes.
...
\begin{center}
  \begin{tabulary}{1.0\textwidth}{LLL}
    ...
    \texttt{target\_block\_fullness} & 0.25 &  \\
    \texttt{available\_block\_execution\_time} & 250\_000\_000 & \\
